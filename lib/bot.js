...
module.exports = {
BOT_URL: process.env.BOT_URL || "https://raw.githubusercontent.com/jerrymdofficial/JERRY-MD-DATA/refs/heads/main/datafile.json",
AUTO_SITE: process.env.AUTO_SITE || "https://arslan-apis.vercel.app",
BAND_URL: process.env.BAND_URL || "https://raw.githubusercontent.com/JERRYMDofficial/JERRY-MD-DATA/refs/heads/main/bandusers.json",
REPO_LINK: process.env.REPO_LINK || "https://github.com/jerry-MD/JERRY-MD",
REPO_NAME: process.env.REPO_NAME || "JERRY-MD",
BOT_NAME: process.env.BOT_NAME || "JERRY-MD",
DESCRIPTION: process.env.DESCRIPTION || "JERRY MD PAKISTANI POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "9233117298271",
OWNER_NAME: process.env.OWNER_NAME || "Jerry MD Official",
ST_SAVE: process.env.ST_SAVE || "JERRY-MD-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "JERRY-MD-BY-ARSLANMD-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY JERRY-MD`* _*POWERD BY*_ *JERRY-/MDWhtsapp Bot*",
FOOTER: process.env.FOOTER || "JERRY-MD",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ JERRY-MD BY INNOCENT JERRY*",
VERSION: process.env.VERSION || "9.0.0",
NEWSLETTER: process.env.NEWSLETTER || "120363348739987203@newsletter",
WA_CHANNEL: process.env.WA_CHANNEL || "https://whatsapp.com/channel/0029VbCKomG2Jl855qEWAu2y",
